$(document).ready(function() {
  ...
  // The code below handles the case where we want to get blog posts for a specific order
  ...
  // If there's no orderId we just get all posts as usual
  else {
    getPosts();
  }
  ...
  function getPosts(order) {
    ...
    $.get("/api/posts" + orderId, function(data) {
